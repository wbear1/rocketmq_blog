...
![dir](https://github.com/wbear1/rocketmq_blog/blob/master/img/dir.png)
...
![commitlog](https://github.com/wbear1/rocketmq_blog/blob/master/img/commitlog.png)
...
![consumequeue](https://github.com/wbear1/rocketmq_blog/blob/master/img/consumequeue.png)
...
![config](https://github.com/wbear1/rocketmq_blog/blob/master/img/config.png)
...
核心设计如下图所示
![arch](https://github.com/wbear1/rocketmq_blog/blob/master/img/arch.png)
...
![MessageStore](https://github.com/wbear1/rocketmq_blog/blob/master/img/MessageStore.png)
  
####3、存储实现
  
##### 内存映射文件MappedFile
初始化MappedFile，主要是将文件映射到MappedByteBuffer，对文件的读写操作就变成对MappedByteBuffer的操作，关于文件的nio操作相关资料比较多，此处不展开。
![MappedFile](https://github.com/wbear1/rocketmq_blog/blob/master/img/MappedFile.png)
